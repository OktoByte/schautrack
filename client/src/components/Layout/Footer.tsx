    ...
    <footer className="mt-auto px-4 py-5">
      <div className="mx-auto max-w-[1100px] flex items-center justify-between gap-4 flex-wrap max-sm:flex-col max-sm:gap-3">
        ...
        <div className="flex items-center gap-1 flex-wrap text-sm">
          <a href="/imprint" className="font-semibold text-muted-foreground transition-colors hover:text-foreground">Imprint</a>
          <span className="text-muted-foreground/40 mx-1.5">&mdash;</span>
          <a href="/privacy" className="font-semibold text-muted-foreground transition-colors hover:text-foreground">Privacy</a>
          <span className="text-muted-foreground/40 mx-1.5">&mdash;</span>
          <a href="/terms" className="font-semibold text-muted-foreground transition-colors hover:text-foreground">Terms</a>
          <span className="text-muted-foreground/40 mx-1.5">&mdash;</span>
          <a
          ...
          {displayVersion && (
            <>
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className={`font-semibold transition-colors hover:text-foreground ${outdated ? 'text-destructive' : 'text-muted-foreground/50'}`}
                title={outdated ? 'Update available — click to view' : 'View on GitHub'}
              >
                <svg width="13" height="13" viewBox="0 0 24 24" fill="currentColor" className="inline-block align-middle mr-1">
